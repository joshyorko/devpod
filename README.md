...
<p>
DevPod reuses the open <a href="https://containers.dev/">DevContainer standard</a> to create a consistent developer experience no matter what backend you want to use.
</p>
